const game = require("../models/game2d.mode1");
const { ObjectId } = require("mongodb");
module.exports = (app) => {
  app.post("/api/game/diemt1", async (req, res) => {
    try {
  ...
  //============================================================================
  app.post("/api/game/logint1", async function (req, res) {
  ...
  app.post("/api/game/getdatausert1", async function (req, res) {
    try {
      // await user.save();
  ...
  app.post("/api/game/getdatausertt1", async function (req, res) {
    try {
      // await user.save();
